...
namespace AngularDotnetCore.Data
{
    public class ApplicationDbContext : ApiAuthorizationDbContext<ApplicationUser>
    {
        ...
        void LoadCategoryGroupsWithCategories(ref ModelBuilder builder)
        {
            ...
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 1, Id = 1, Icon = "meeting_room", Name = "Thuê (Share) Phòng", ExternalUrl = "https://mraovat.nguoi-viet.com/classified/phong-cho-thue-rooms-to-share-browse-88.aspx" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 1, Id = 2, Icon = "apartment", Name = "Cần & Cho Thuê Nhà, Chung Cư, Apt. Condo", ExternalUrl = "https://mraovat.nguoi-viet.com/classified/nha-cho-thue-house-for-rent-browse-86.aspx, https://mraovat.nguoi-viet.com/classified/apartment-condo-cho-thue-for-rent-browse-87.aspx" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 1, Id = 3, Icon = "storefront", Name = "Cần & Cho Thuê Văn Phòng, Cửa Tiệm" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 1, Id = 4, Icon = "emoji_symbols", Name = "Cần & Cho Thuê Các Thứ Khác" });
                                                                                        
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 2, Id = 5, Icon = "soap", Name = "Nail & Beauty Spa Supply" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 2, Id = 6, Icon = "drive_eta", Name = "Mua Bán Xe / Car", ExternalUrl= "https://mraovat.nguoi-viet.com/classified/xe-ban-auto-for-sale-browse-91.aspx" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 2, Id = 7, Icon = "directions_boat", Name = "Mua Bán Sĩ, Xuất Nhập Khẩu" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 2, Id = 8, Icon = "shopping_cart", Name = "Mua Bán Các Loại", ExternalUrl= "https://mraovat.nguoi-viet.com/classified/ban-cac-loai-items-for-sale-browse-118.aspx" });


            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 3, Id = 9, Icon = "dry", Name = "Cần Thợ Nails & Tóc", ExternalUrl= "https://mraovat.nguoi-viet.com/classified/viec-hair-nail-job-browse-96.aspx" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 3, Id = 10, Icon = "baby_changing_station", Name = "Cần Chăm Sóc Trẻ Em, Người Già" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 3, Id = 11, Icon = "baby_changing_station", Name = "Nhận Giữ Trẻ Em Và Chăm Sóc Người Già", ExternalUrl= "https://mraovat.nguoi-viet.com/classified/giu-tre-child-care-babysitter-browse-117.aspx" });
            ...
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 3, Id = 13, Icon = "storefront", Name = "Việc Hãng Xưởng / Manufacturing Job", ExternalUrl= "https://mraovat.nguoi-viet.com/classified/viec-hang-xuong-manufacturing-jobs-browse-95.aspx" });
            ...
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 3, Id = 17, Icon = "engineering", Name = "Các việc khác (General Jobs)", ExternalUrl= "https://mraovat.nguoi-viet.com/classified/viec-lam-employment-browse-93.aspx" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 3, Id = 18, Icon = "people", Name = "Người Tìm Việc / Looking for Job" });

            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 4, Id = 19, Icon = "store_mall_directory", Name = "Mua Bán Tiệm Nail & Tóc / Salon Office Transfer" });
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 4, Id = 20, Icon = "store_mall_directory ", Name = "Mua Bán Cơ Sở Thương Mại / Business Office", ExternalUrl = "https://mraovat.nguoi-viet.com/classified/sang-nhuong-co-so-business-opportunities-browse-92.aspx" });
            ...
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 5, Id = 25, Icon = "plumbing", Name = "Sửa Điện, Ống Nước / Electric, Plumbing", ExternalUrl= "https://mraovat.nguoi-viet.com/classified/sua-ong-nuoc-plumbing-browse-107.aspx" });
            ...
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 5, Id = 29, Icon = "computer", Name = "Máy Tính, Phần Mềm, Web / IT" });
            ...
            builder.Entity<Category>().HasData(new Category { CategoryGroupId = 5, Id = 39, Icon = "emoji_symbols", Name = "Các Dịch Vụ Khác / Other Services", 
